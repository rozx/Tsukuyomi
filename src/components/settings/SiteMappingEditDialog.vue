...
/**
 * 网站映射 · 编辑对话框（已选条目排序 + 可用代理 / Firecrawl 添加）。
 * 状态来自 injectSiteMappingSettings()。
 */
        ...
        <div v-else class="space-y-2 mb-3">
          ...
          >
            <div class="flex-1 flex items-center gap-2">
              ...
              <Tag
                :value="s.getProxyDisplayName(proxyUrl)"
                :severity="s.mappingTagSeverity(true, proxyUrl)"
                :title="s.mappingTagTitle(proxyUrl)"
