...
目前只能通过编辑卷标题来手动调整卷的顺序（如添加序号）。
future: 拖拽排序卷的功能正在开发中。
...
建议使用"从在线获取更新"功能自动从网站导入章节,这是批量添加章节最高效的方式。

### 可以批量导入章节结构吗?

目前的主要方式是使用"从在线获取更新"功能从小说网站自动导入章节结构。系统会自动创建卷和章节,并填充内容。
