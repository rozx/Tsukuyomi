...
- **基于关联实体**：AI 会自动扫描章节内容中出现的**术语**和**角色**
- **检索关联记忆**：自动提取与这些术语和角色关联的记忆
- **排序策略**：根据 LRU（最近最少使用）策略，优先根据最近访问时间排序，选取最相关的 Top 10 条记忆

> ⚠️ **注意**：仅关联到"书籍"或"章节"但未关联特定术语/角色的记忆，目前不会被自动选取。建议将重要记忆关联到具体的术语或角色以确保被 AI 引用。
